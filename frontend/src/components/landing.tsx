...
const BACKEND_REQUEST_HANDLER_URL = "localhost:3001";
      ...
      {deployed && <Card className="w-full max-w-md mt-8">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Input id="deployed-url" readOnly type="url" value={`http://${uploadId}.${BACKEND_REQUEST_HANDLER_URL}/index.html`} />
          </div>
          <br />
          <Button className="w-full" variant="outline">
            <a href={`http://${uploadId}.${BACKEND_REQUEST_HANDLER_URL}/index.html`} target="_blank">
              Visit Website
            </a>
          </Button>
        </CardContent>
